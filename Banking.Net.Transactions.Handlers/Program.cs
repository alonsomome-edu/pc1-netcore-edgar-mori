...
namespace Banking.Net.Transactions.Handlers
{
    class Program
    {
        static async Task Main(string[] args)
        {
            Console.Title = "Banking.Transactions";
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                {
                    var endpointConfiguration = ConfigureEndpoint("Banking.Transactions");
        ...
        public static EndpointConfiguration ConfigureEndpoint(string endpointName)
        {
            ...
            routing.RouteToEndpoint(typeof(DepositMoney).Assembly, "Banking.BankAccounts");
            return endpointConfiguration;
        }
